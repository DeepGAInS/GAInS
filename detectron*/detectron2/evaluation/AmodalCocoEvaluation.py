...
class AmodalEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None, load_from=None):
        """
        Args:
    ...
    def _eval_predictions(self, tasks, predictions):
        ...
        print(self._load_from)
        if self._load_from: 
          coco_results=json.load(open(self._load_from,'r',encoding='utf-8'))
# 
