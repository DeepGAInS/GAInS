...
COCO_CATEGORIES = [
  	#isbi\segpc
    #{"color": [220, 20, 60], "isthing": 1, "id": 0, "name": "Cell"},
    #{"color": [119, 11, 32], "isthing": 1, "id": 1, "name": "Nuclei"},

    #kaggle2018:
    {"color": [119, 11, 32], "isthing": 1, "id": 1, "name": "Nucleus"},
    
    #Chromosome:
    #{"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "chromosome"},
